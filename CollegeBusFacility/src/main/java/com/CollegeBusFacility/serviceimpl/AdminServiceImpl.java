...
public class AdminServiceImpl implements AdminService {
	...
	public String Addbus(Bus bus) {
	    ...
	    try
		{
	    	int  r= jt.update(str, new Object[] {bus.getBusnum(), bus.getRoutenum(), bus.getDrivername(),bus.getDriverphonenum(),bus.getDestination(),bus.getStoppingpoints(),bus.getFee()});
			if(r>=1)
			{
	...
	public List<Bus> Showall() {
			...
			String str="Select * from addbusroute";
			List<Bus> listAll=jt.query(str, new BeanPropertyRowMapper(Bus.class));
			return listAll;
	}*/
