    ...
    <div class="Register" action="register">
      <h2>Register</h2>
          <form id="Register" method="post">
                <label>Id : </label>
                <br>
                <input type="number" name="bnum" id="bnumber" placeholder="Enter Student/faculty id">
                <br><br>
                <label>Name : </label>
                <br>
                <input type="text" name="dname" id="name" placeholder="Enter Studentfaculty  Name">
                <br><br>
              ...
              <label>Phone Number : </label>
                <br>
                <input type="tel" name="pnum" id="pnumber" placeholder="Enter Studentfaculty Ph-no">
                <br><br>
                <label for="address">Address:</label>
                  <br>
                  <textarea name="address" id="address" cols="30" rows="10" placeholder="Enter Student/faculty Address" required></textarea>
                  <br><br>
