...
<div class="col-sm-8">
<input type="text" name="id" readonly class="form-control" value="${user.id }" />
</div>
</div>
<div class="form-group form-row">
...
<div class="form-group form-row">
    ...
    <div class="col-sm-8">
    <input type="date" name="dob"   readonly class="form-control" value="${user.dob }"/>
    </div></div>
<div class="form-group form-row">
...
<div class="form-group form-row">
    ...
    <div class="col-sm-8">
    <input type="text" name="address" value="${user.department }"
    class="form-control" />
    </div>
    </div>
<div class="form-group form-row">
